...
class ProjectController extends Controller
{
    ...
    */
    public function projectAction(Request $request)
    {
      ...
      // -- map
      $map = $this->getProjectMap($p);
      

      return $this->render('BrickstormSolidRBundle:Project:project.html.twig', array(
        'project' => $p,
        'map'     => $map
      ));
    }
    ...
    */
    public function participateAction(Request $request)
    {
      ...
      return $this->render('BrickstormSolidRBundle:Project:participate.html.twig', array(
        'project' => $p,
        'map'     => $map
      ));
    }
    ...
    *
    */
    public function getProjectMap(Project $p)
    {
